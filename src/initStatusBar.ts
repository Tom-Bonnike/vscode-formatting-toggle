...
const initStatusBar = (initialDisableStatus: boolean): StatusBarItem => {
  ...
  // position would sometime switch randomly.
  ...
  statusBar.text = getStatusBarText(initialDisableStatus)
  statusBar.show()
